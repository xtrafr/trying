...
/**
 * Footer, clean glass design at the bottom
 * @author xtra
 * 
 * got that animated divider that expands from center,
 * availability badge pulses to show I'm open for work
 */
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 relative z-10">
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, scaleX: 1 }} // grows from center
          viewport={{ once: true }}
