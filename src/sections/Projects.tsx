...
export default function Projects() {
  ...
  return (
    <section
      id="work"
      ref={ref}
      className="relative overflow-hidden bg-bg-secondary px-6 py-20 md:py-32"
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {personalProjects.slice(0, expandedPersonal ? personalProjects.length : 3).map((project, index) => (
              <PersonalProjectCard
                key={project.id}
                project={project}
                index={index}
