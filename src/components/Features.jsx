        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-dark-card rounded-2xl p-5 sm:p-6 border border-primary/20 hover:border-primary/50 transition-all duration-300 card-glow hover:card-glow-hover"
            >
              <motion.div
