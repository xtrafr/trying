...
import { resellContainer, resellItem } from '../utils/animationVariants'
  ...
  return (
    <section id="reselling" className="py-20 bg-dark-lighter relative overflow-hidden scroll-mt-24 md:scroll-mt-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={resellContainer} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid md:grid-cols-3 gap-6 md:gap-8">
          <motion.div variants={resellItem} className="bg-dark-card rounded-2xl p-6 border border-primary/20 card-glow hover:card-glow-hover transition-all duration-200 text-left">
            <div className="mb-3">
