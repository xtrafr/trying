  ...
  return (
    <section className="py-32 bg-dark relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-primary via-purple-500 to-blue-500 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '3s' }} />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-tr from-blue-500 via-primary to-cyan-500 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
      </div>
